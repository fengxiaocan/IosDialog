...
public class InputDialog implements LifecycleData {

    private final Context context;
    private final AlertDialog dialog;
    private final TextView txt_title;
    private final EditText txt_input;
    //addView 父容器
    ...
    public InputDialog(Context context) {
        ...
        setLeftButton(R.string.cancel, null, true);
    ...
    public InputDialog setLeftButton(String text,
                                     final IDialogListener listener, final boolean dismiss) {
        showLeftBtn = true;
    ...
    public InputDialog setLeftButton(int text, final IDialogListener listener) {
        return setLeftButton(context.getString(text), listener, true);
    }
     ...
     * @return the ios dialog
     */
    public InputDialog setLeftButton(int text, final IDialogListener listener, boolean dismiss) {
